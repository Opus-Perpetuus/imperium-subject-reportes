...
WORKDIR /app
LABEL org.opencontainers.image.source="https://github.com/Opus-Perpetuus/imperium-subject-reportes"
LABEL org.opencontainers.image.url="https://github.com/Opus-Perpetuus/imperium-subject-reportes"
...
COPY src ./src
ENV PORT=3000 \
    SUBJECT_TECHNICAL_ID=subject-reportes \
    KIRLET_TECHNICAL_ID=subject-reportes \
    DATA_DIR=/data \
    SUBJECT_AUTH=on \
    KIRLET_AUTH=on
